    ...
    <Card className="bg-[var(--surface)]">
      ...
      <CardContent className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-2">
          <TemplateShareDialog label="Export all" className="w-full" />
        ...
        <div className="flex flex-col gap-2">
          ...
          {shares === undefined ? (
            ...
            <p className="text-muted-foreground text-sm">
              No live links. Anyone with a link can import the templates it was
              created from, so revoke one when you&apos;re done sharing.
            </p>
          ) : (
